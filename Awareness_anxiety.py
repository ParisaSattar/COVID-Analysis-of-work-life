...
for l in range (2):
    ...
    for c in range(len(per_0_DASS_score)):
        ...
        elif (per_0_DASS_score[c][l+2]>=20):
            extreme_0 += 1
    ...
    for ys in range(len(per_25_DASS_score)):
        ...
        elif (per_25_DASS_score[ys][l+2]>=20):
            extreme_25 += 1
    ...
    for y in range(len(per_50_DASS_score)):
        ...
        elif (per_50_DASS_score[y][l+2]>=20):
            extreme_50 += 1
    ...
    for ea in range(len(per_75_DASS_score)):
        ...
        elif (per_75_DASS_score[ea][l+2]>=20):
            extreme_75 += 1
    ...
    for ma in range(len(per_100_DASS_score)):
        ...
        elif (per_100_DASS_score[ma][l+2]>=20):
            extreme_100 += 1
